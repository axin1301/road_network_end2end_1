...
def main():
    print("Hello World")
    #test()
    with open("time_log_last10cts2.txt","w") as log_f:
        for year in [2021]: #2017,
            for county in ['mingshuixian','xijixian','congjiangxian']: #'debaoxian','zhuoluxian','shangyixian','songxian','sinanxian','tongjiangxian','lipingxian',
                if county == 'debaoxian':
                    continue
