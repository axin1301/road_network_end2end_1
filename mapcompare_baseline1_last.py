...
def mapcompare_baseline1(data_path,dataset,solution,compute_mode,year,xxxx):
        ...
        for b in [45]:#,30
            for t in [i*10]:#
                for c in ['knn']:#,'wmm'     
                    ...
                    f_data2 = f_data + '/../../../temp_output/GraphSamplingToolkit-main/'+"{dataset}_{year}".format(dataset=dataset, year = year)
    ...
    df.to_csv('../output/'+dataset+'_'+str(year)+'_'+xxxx+'.csv', index=False)