...
def mapcompare(data_path,dataset,solution,compute_mode,year):
        ...
        for b in [30]:#,45
            for t in [i*10]:#
                for c in ['knn']:#,'wmm'     
                    ...
                    f_ground_truth = "{folder}/groundtruth/{dataset}_{year}_{{type}}.txt".format(folder=f_data, dataset=dataset, year = year)
